...
first_clonal_counts_cumulative<-clonal_count_v3(first_SE[,first_PB_sample_selection], plot_over = "Month_timepoint", 
                                                   group_by = "Cell.Type", group_by_choices = c("T", "B","Mono", "Gr","CD16+" ,"CD56+"), line_size = 1, 
                                                   cumulative = T, plot_total_cum = T, your_title = "11021142 Unique Clonal Count")

second_clonal_count_cumulative<-clonal_count_v3(second_SE[,second_PB_sample_selection], 
                                                 plot_over = "Month_timepoint", group_by = "Cell.Type", 
                                                 group_by_choices =c("T", "B","Mono", "Gr","CD16+" ,"CD56+"),  
                                                 line_size = 1,  cumulative = T, plot_total_cum = T,your_title = "10U004 Unique Clonal Count")

third_clonal_counts_cumulative<-clonal_count_v3(third_SE[,third_PB_sample_selection], plot_over = "Month_timepoint",
                                             group_by = "Cell.Type", group_by_choices = c("T", "B","Mono", "Gr","CD16+" ,"CD56+"), 
                                             cumulative = T, plot_total_cum = T, line_size = 1, your_title = "H84D Unique Clonal Count")
...
```{r}
ZG66_clonal_counts_cumulative_table<-clonal_count_v3(ZG66_SE[,ZG66_PBGr_sample_selection], plot_over = "Month_timepoint",
...
ZJ31_clonal_counts_cumulative_table<-clonal_count_v3(ZJ31_SE[,ZJ31_PBGr_sample_selection], plot_over = "months",
                                                 group_by = "simple_cell_type", group_by_choices = "Gr",
                                                 line_size = 1, cumulative = T, plot_total_cum = T, your_title = "ZJ31 Cumulative PB Gr Clonal Count", return_table = T) 
ZH33_clonal_counts_cumulative_table<-clonal_count_v3(ZH33_SE[,ZH33_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices = "Gr",
                                                 line_size = 1, cumulative = T, plot_total_cum = T, your_title = "ZH33 PB Gr Cumulative PB Gr Clonal Count", return_table = T) 

ZH19_clonal_counts_cumulative_table<-clonal_count_v3(ZH19_SE[,ZH19_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices = "Gr",
                                                 line_size = 1, cumulative = T, plot_total_cum = T, your_title = "ZH19 PB Gr Cumulative PB Gr Clonal Count", return_table = T)

ZK22_clonal_counts_cumulative_table<-clonal_count_v3(ZK22_SE[,ZK22_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices = "Gr",
                                                 line_size = 1, cumulative = T, plot_total_cum = T, your_title = "ZH19 PB Gr Cumulative PB Gr Clonal Count", return_table = T)
```

```{r}
ZG66_clonal_counts_unique_table<-clonal_count_v3(ZG66_SE[,ZG66_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices ="Gr",
                                                 line_size = 1, cumulative = F,  
                                                 your_title = "ZG66 PB Gr Unique Clonal Count", return_table = T) 
ZJ31_clonal_counts_unique_table<-clonal_count_v3(ZJ31_SE[,ZJ31_PBGr_sample_selection], plot_over = "months",
                                                 group_by = "simple_cell_type", group_by_choices = "Gr",
                                                 line_size = 1, cumulative = F,  your_title = "ZJ31 Unique PB Gr Clonal Count", return_table = T) 
ZH33_clonal_counts_unique_table<-clonal_count_v3(ZH33_SE[,ZH33_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices = "Gr",
                                                 line_size = 1, cumulative = F, your_title = "ZH33 Unique PB Gr Clonal Count", return_table = T) 

ZH19_clonal_counts_unique_table<-clonal_count_v3(ZH19_SE[,ZH19_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices = "Gr",
                                                 line_size = 1, cumulative = F,  your_title = "ZH19 Unique PB Gr Clonal Count", return_table = T)

ZK22_clonal_counts_unique_table<-clonal_count_v3(ZK22_SE[,ZK22_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices = "Gr",
                                                 line_size = 1, cumulative = F, your_title = "ZH19 Unique PB Gr Clonal Count", return_table = T)
```

```{r}
ZG66_shannon_table<-clonal_diversity(ZG66_SE_shannon[,ZG66_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices ="Gr",
                                                 line_size = 1, 
                                                 your_title = "ZG66 Shannon Diversity", return_table = T) 
ZH19_shannon_table<-clonal_diversity(ZH19_SE_shannon[,ZH19_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices ="Gr",
                                                 line_size = 1, 
                                                 your_title = "ZH19 Shannon Diversity", return_table = T) 
ZH33_shannon_table<-clonal_diversity(ZH33_SE_shannon[,ZH33_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices ="Gr",
                                                 line_size = 1, 
                                                 your_title = "ZH33 Shannon Diversity", return_table = T) 
ZJ31_shannon_table<-clonal_diversity(ZJ31_SE_shannon[,ZJ31_PBGr_sample_selection], plot_over = "months",
                                                 group_by = "simple_cell_type", group_by_choices ="Gr",
                                                 line_size = 1, 
                                                 your_title = "ZJ31 Shannon Diversity", return_table = T) 
ZK22_shannon_table<-clonal_diversity(ZK22_SE_shannon[,ZK22_PBGr_sample_selection], plot_over = "Month_timepoint",
                                                 group_by = "simple_cell_type", group_by_choices ="Gr",
                                                 line_size = 1, 
