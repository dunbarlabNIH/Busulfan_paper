...
metadata_df <- read.delim(file = file.path(read_dir,paste(monkey_ID, "_metadata_",process_date,"_edited_20220707.txt", sep="")),
                          sep = "\t")
...
metadata_df[sample_index, ]$simple_cell_type <- c("T", "B", "Mono", "Gr", "CD16+", "CD56+", 
                                                  "T", "B", "Mono", "Gr", "CD16+", "CD56+",
                                                  "T", "B", "Mono", "Gr", "CD16+", "CD56+",
                                                  "T", "B", "Mono", "Gr", "CD16+",
                                                  "T", "B", "Mono", "Gr", "CD16+", "CD56+",
                                                  "T", "B", "Mono", "Gr", "CD16+")
