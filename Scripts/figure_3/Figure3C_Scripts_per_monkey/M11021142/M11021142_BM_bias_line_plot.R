...
metadata_df[sample_index[c(1,3)],]$Cell.Type <- "LBM"
metadata_df[sample_index[c(2,4)],]$Cell.Type <- "RBM"
...
cell_type1 <- "LBM"
cell_type2 <- "RBM"
timepoints <- sort(intersect(your_SE$Month_timepoint[which(your_SE$Cell.Type == cell_type1)], 
                             your_SE$Month_timepoint[which(your_SE$Cell.Type == cell_type2)]))
